...
def auto_features_main():
    ...
    # Load data
    full_df = pd.read_csv(find_data_file("trip_recommendation_service_dataset.csv"))

    df = pd.read_csv(find_data_file("trip_recommendation_service_dataset.csv"))
